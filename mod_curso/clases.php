  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Fixed Layout </h1><?php print_r($_SESSION); ?>
          </div>
          <div class="col-sm-6">
                    ...
                    <div class="col-12">
                      ...
                      <div>
                        <div class="timeline-item" >
                          <h3 class="timeline-header" style="background-color:hsla(0,100%,50%,0.5);"><a href="#">Titulo</a> y descripción de el Video</h3>
                          <div class="timeline-body">
                            <div class="embed-responsive embed-responsive-16by9">
                              <video  controls="" muted="" src="cursos/curso1/Video1.mp4" type="video/mp4" class="product-image" alt="Product Image"></video>
                            </div>
...
<!--================ LISTADO DE VIDEOS ===============================================================-->
                  <div class="col-6 col-sm-3" class="product-image-thumbs " id="lista_video">
                    ...
                    <div class="attachment-block clearfix">
                      <div class="row">
                        ...
                        <div class="col-sm-5" >
                          <div class="product-image-thumb" ><video src="cursos/curso1/Video3.mp4" muted=""></video></div>
                          <!--video src="cursos/curso1/Video2.mp4" alt="Product Image" autoplay="false"></video-->
                          <!--img class="attachment-img" src="../AdminLTE-3.2.0/dist/img/photo1.png" alt="Attachment Image"-->
                        </div>
                        <div class="col-sm-6">
                    ...
                    <!--div class="attachment-block clearfix">
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <h6 class="attachment-heading"><a href="https://www.lipsum.com/">1Lorem ipsum text generator de prueba ds sd sddf sdf sdfs d sewefwefwef</a></h6>
                        </div>
